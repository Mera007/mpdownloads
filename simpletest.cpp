...
//
// BEACHTEN:
// (1) Die Zeichenfolge ContDynArray ist in der ganzen Datei durch den Klassennamen
...
#include <cstdlib>
#include <cctype>
#include "BaidiukSeparateChaining.h"
...
#ifdef SIZE
                    c = new BaidiukSeparateChaining<ElementType,SIZE>;
#else
                    c = new BaidiukSeparateChaining<ElementType>;
#endif
                }
